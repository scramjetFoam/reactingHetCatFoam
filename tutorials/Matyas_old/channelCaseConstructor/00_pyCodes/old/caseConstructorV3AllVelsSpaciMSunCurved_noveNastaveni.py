...
# typ='C'
# if typ == 'uC':
    # baseCase = '../10_baseCaseVSpaciV2_NN/'
# else:
    # baseCase = '../10_baseCaseVSpaciV2_NN_curved/'
baseCase = '../10_bsCaseSpHTV1/'
outFolder= '../40_noveNastaveni/Middle/'
outFolder= '../40_noveNastaveni/heatTake/'
...
name = '%s_V1_'%typ
name = 'Ref_%s_V1_'%typ
name = 'heatTake/%s_V6_'%typ
# name = '60x60x80_%s_V6_'%typ
# name = 'Ref_%s_V6_'%typ
# name = 'uC_V1_'
# name = 'NN_V9Spaci'
...
wrInt       = 200                                                       #simulation write interval
...
nChY= 4                                                                 #number of channels in hor. dir.
# nChX= 1
# nChY= 1
...
for fraction in fracLst:
    for Vcap in VcapLst:
        ...
        pt1 = [3*WCh+2*WWl+radius[1]+-edgS.verPoint2[0]-WWl/2+offset[0],3*WCh+2*WWl+radius[1]+edgS.verPoint2[1]-WWl/2+offset[1],LBf+fraction*LCh]
