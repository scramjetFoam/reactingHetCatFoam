...
WWl = 227e-6                                                            #wall thickness
WCh = 1243e-6*0.5                                                       #channel width (square)
nChX= 4                                                                 #number of channels in hor. dir.
nChY= 4
...
LCh  = 29.0e-3                                                     	#channel length (total, including the plugs, but WITHOUT the buffers)
...
for uIn in uInLst:
    ...
    headStr = blockLst[0][8][8].retFileHeaderStr()
    for line in headStr:
        bMD.write(line)
