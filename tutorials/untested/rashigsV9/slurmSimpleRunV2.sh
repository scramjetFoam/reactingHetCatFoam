...
# srun -n16 snappyHexMesh -dict system/snappyHexMeshDictZkouska -parallel -overwrite >> log.snappyHexMesh
# reconstructParMesh -mergeTol 1 -constant >> log.reconstruct2
