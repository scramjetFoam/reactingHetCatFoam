...
# nChY= 3                                                                 #number of channels in hor. dir.
nChX= 1
nChY= 1
...
# dX,dY,dZ   = 40e-6,40e-6,30e-6
# dX,dY,dZ   = 50e-6,50e-6,30e-6
# dX,dY,dZ   = 60e-6,60e-6,30e-6

# dX,dY,dZ   = 30e-6,30e-6,40e-6
# dX,dY,dZ   = 40e-6,40e-6,40e-6
# dX,dY,dZ   = 50e-6,50e-6,40e-6
# dX,dY,dZ   = 60e-6,60e-6,40e-6

dX,dY,dZ   = 30e-6,30e-6,50e-6
dX,dY,dZ   = 40e-6,40e-6,50e-6
dX,dY,dZ   = 50e-6,50e-6,50e-6
dX,dY,dZ   = 60e-6,60e-6,50e-6


# dX,dY,dZ   = 20e-6,20e-6,80e-6
dX,dY,dZ   = 30e-6,30e-6,80e-6
dX,dY,dZ   = 40e-6,40e-6,80e-6
dX,dY,dZ   = 50e-6,50e-6,80e-6
# dX,dY,dZ   = 60e-6,60e-6,50e-6

# dX,dY,dZ   = 30e-6,30e-6,80e-6
dX,dY,dZ   = 30e-6,30e-6,100e-6
# dX,dY,dZ   = 50e-6,50e-6,80e-6
...
for fraction in fracLst:
    for Vcap in VcapLst:
        ...
        pt1 = [1*WCh+WWl+radius[1]/2.0**0.5+-edgS.verPoint2[0]-WWl/2+offset[0],3*WCh+2*WWl+radius[1]/2.0**0.5+edgS.verPoint2[1]-WWl/2+offset[1],LBf+fraction*LCh]
        ...
        x = [pt2[0],pt2[0]+WWl+WCh*2,pt2[0]+2*(WWl+WCh*2),pt2[0]-WWl-WCh*2]
