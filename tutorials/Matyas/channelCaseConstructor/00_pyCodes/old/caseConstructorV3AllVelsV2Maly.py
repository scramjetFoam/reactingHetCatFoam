...
# I/O DATA
#-----------------------------------------------------------------------
baseCase = '../10_baseCaseVSpaciV2_curved/'
...
endTime     = 1500                                                      #simulation endTime
...
for fraction in fracLst:
    for Vcap in VcapLst:
        ...
        # pt1 = [3*WCh+2*WWl+radius[1]/2.0**0.5+-edgS.verPoint2[0]-WWl/2+offset[0],3*WCh+2*WWl+radius[1]/2.0**0.5+edgS.verPoint2[1]-WWl/2+offset[1],LBf+fraction*LCh]
